...
exports.addMatch = async (req, res) => {
    try {
        ...
        const homePlayersParsed = Array.isArray(homePlayers) ? homePlayers : JSON.parse(homePlayers);
        const awayPlayersParsed = Array.isArray(awayPlayers) ? awayPlayers : JSON.parse(awayPlayers);
